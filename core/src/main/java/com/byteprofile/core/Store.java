...
public class Store {
    ...
    public void createFlameGraphFile() throws IOException {
        try (OutputStream os = new BufferedOutputStream(java.nio.file.Files.newOutputStream(Path.of("/tmp/flamegraph.html")))) {
